...
os.environ.setdefault("MPLCONFIGDIR", str(Path(tempfile.gettempdir()) / "eda-wine-mpl"))
os.environ.setdefault("IPYTHONDIR", str(Path(tempfile.gettempdir()) / "eda-wine-ipython"))
...
body = body.replace('<title>Notebook</title>', '<title>EDA Wine Quality — Muhammad Fierlyan Irwandi</title>')
captions = [
    'Histogram alkohol: rata-rata 10,42 dan median 10,20 pada skala asli dataset.',
    'Distribusi quality: 10, 53, 681, 638, 199, dan 18 observasi untuk skor 3 sampai 8.',
    'Boxplot alkohol menurut quality: median 9,70 pada skor 5 dan 12,15 pada skor 8.',
    'Scatter plot alkohol dan volatile acidity, diwarnai berdasarkan enam skor quality.',
    'Heatmap Pearson: alkohol dengan quality 0,476 dan volatile acidity dengan quality minus 0,391.'
]
for caption in captions:
    body = body.replace('alt="No description has been provided for this image"', f'alt="{caption}"', 1)
css = '''<style>
body { background:#f3f6f8; color:#203044; }
...
.jp-RenderedHTMLCommon h2 { color:#0f766e; margin-top:2em; padding-top:.4em; border-top:1px solid #dce6e8; }
...
.jp-RenderedHTMLCommon a { color:#0f766e; }
