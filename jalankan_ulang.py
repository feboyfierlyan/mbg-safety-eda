...
os.environ.setdefault("MPLCONFIGDIR", str(Path(tempfile.gettempdir()) / "eda-student-mpl"))
os.environ.setdefault("IPYTHONDIR", str(Path(tempfile.gettempdir()) / "eda-student-ipython"))
...
body = body.replace('<title>Notebook</title>', '<title>Belajar Lebih Lama, Nilai Lebih Tinggi? — Muhammad Fierlyan Irwandi</title>')
captions = [
    'Histogram nilai akhir 649 siswa pada skala 0 sampai 100; median 60.',
    'Jumlah siswa pada empat kategori belajar per minggu: 212, 305, 97, dan 35.',
    'Rata-rata nilai pada empat kategori belajar: 54,2; 60,5; 66,1; 65,3.',
    'Scatter plot nilai periode kedua dan akhir; ukuran titik menunjukkan jumlah siswa, korelasi 0,92.'
]
...
.jp-RenderedHTMLCommon h2 { color:#168278; margin-top:2em; padding-top:.4em; border-top:1px solid #dce6e8; }
...
.jp-RenderedHTMLCommon a { color:#168278; }
...
assert image_count == 4, f'Hanya {image_count} gambar tertanam.'
